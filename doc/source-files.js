...
sourcesIndex["aero_kernel"] = {"name":"","dirs":[{"name":"acpi","files":["fadt.rs","hpet.rs","madt.rs","mcfg.rs","mod.rs","rsdp.rs","sdt.rs"]},{"name":"arch","dirs":[{"name":"x86_64","dirs":[{"name":"interrupts","files":["exceptions.rs","idt.rs","irq.rs","mod.rs"]}],"files":["gdt.rs","mod.rs"]}],"files":["mod.rs"]},{"name":"drivers","files":["ahci.rs","keyboard.rs","mod.rs","mouse.rs","pci.rs","uart_16550.rs"]},{"name":"fs","dirs":[{"name":"vfs","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"mem","dirs":[{"name":"paging","files":["mod.rs"]}],"files":["alloc.rs","mod.rs","pti.rs"]},{"name":"syscall","files":["fs.rs","mod.rs","process.rs","time.rs"]},{"name":"userland","files":["mod.rs","process.rs","scheduler.rs"]},{"name":"utils","files":["buffer.rs","io.rs","linker.rs","mod.rs"]}],"files":["apic.rs","logger.rs","main.rs","rendy.rs","tests.rs","time.rs","tls.rs","unwind.rs"]};
